                                    ...
                                    <div class="form-row">
                                        <div class="col-md-5 mb-3">
                                            ...
                                            <div class="invalid-feedback">
                                                Por favor ingrese solo una palabra
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="col-md-5 mb-3">
                                            ...
                                            <div class="invalid-feedback">
                                                Por favor seleccione un número entre 1 y 20
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-row">
                        ...
                        (function() {
                            ...
                            var validation = Array.prototype.filter.call(forms, function(form) {
                                form.addEventListener('submit', function(event) {
                                    if (form.checkValidity() === false || document.getElementById('producto').value.includes(' ')) {
